...
# create Table 1
mytex(tab, file="table1_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=F, align=c("c","l","c","c","c|","c","c","c|","c","c","c"), col.headers = "\\hline \\multicolumn{1}{l}{} & \\multicolumn{3}{c|}{L-B} & \\multicolumn{3}{c|}{L-DB} &\\multicolumn{3}{c}{L-FDB} \\\\  \n \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{$e=-0.25$} & \\multicolumn{1}{c}{$e=0$} & \\multicolumn{1}{c|}{$e=0.25$} & \\multicolumn{1}{c}{$e=-0.25$} & \\multicolumn{1}{c}{$e=0$} & \\multicolumn{1}{c|}{$e=0.25$} & \\multicolumn{1}{c}{$e=-0.25$} & \\multicolumn{1}{c}{$e=0$} & \\multicolumn{1}{c}{$e=0.25$} \\\\ \\hline\n", comment = FALSE, hline = 4)
...
# create Table 2
mytex(tab, file="table2_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=T, align=c("c","l","c","c","c","c|","c","c","c","c"), col.headers = "\\hline \\multicolumn{1}{c}{} & \\multicolumn{4}{c|}{TL-B} & \\multicolumn{4}{c}{TL-FDB}\\\\  \n \\multicolumn{1}{c}{$(e_{min},e_{max})$} & \\multicolumn{1}{c}{$(0.1,0.9)$} & \\multicolumn{1}{c}{$(0.2,0.8)$} & \\multicolumn{1}{c}{$(0.3,0.7)$} & \\multicolumn{1}{c|}{$(0.4,0.6)$} & \\multicolumn{1}{c}{$(0.1,0.9)$} & \\multicolumn{1}{c}{$(0.2,0.8)$} & \\multicolumn{1}{c}{$(0.3,0.7)$} & \\multicolumn{1}{c}{$(0.4,0.6)$} \\\\ \\hline \n", comment = FALSE)
...
# create Table 3
mytex(tab, file="table3_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=F, align=c("c","l","c","c","c|","c","c","c"), col.headers = "\\hline \\multicolumn{1}{l}{} & \\multicolumn{3}{c|}{TL-B} &\\multicolumn{3}{c}{TL-FDB} \\\\  \n \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{$e_0=-0.25$} & \\multicolumn{1}{c}{$e_0=0$} & \\multicolumn{1}{c|}{$e_0=0.25$} & \\multicolumn{1}{c}{$e_0=-0.25$} & \\multicolumn{1}{c}{$e_0=0$} & \\multicolumn{1}{c}{$e_0=0.25$} \\\\ \\hline\n", comment = FALSE, hline = 4)
...
# create Table 4
mytex(tab, file="table4_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=F, align=c("c","l","c","c","c|","c","c","c"), col.headers = "\\hline \\multicolumn{1}{l}{} & \\multicolumn{3}{c|}{l-B} &\\multicolumn{3}{c}{l-FDB} \\\\  \n \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{$e=-0.25$} & \\multicolumn{1}{c}{$e=0$} & \\multicolumn{1}{c|}{$e=0.25$} & \\multicolumn{1}{c}{$e=-0.25$} & \\multicolumn{1}{c}{$e=0$} & \\multicolumn{1}{c}{$e=0.25$} \\\\ \\hline\n", comment = FALSE, hline = 6)
...
# create Table 5
mytex(tab, file="table5_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=F, align=c("c","l","c","c","c","c|","c","c","c","c"), col.headers = "\\hline \\multicolumn{1}{l}{} & \\multicolumn{4}{c|}{Tl-B} &\\multicolumn{4}{c}{Tl-FDB} \\\\  \n \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{size} & \\multicolumn{1}{c}{$e_0=-0.25$} & \\multicolumn{1}{c}{$e_0=0$} & \\multicolumn{1}{c|}{$e_0=0.25$} & \\multicolumn{1}{c}{size} & \\multicolumn{1}{c}{$e_0=-0.25$} & \\multicolumn{1}{c}{$e_0=0$} & \\multicolumn{1}{c}{$e_0=0.25$} \\\\ \\hline\n", comment = FALSE, hline = 4)
...
# create Table A.1
mytex(tab, file="tableA1_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=T, align=c("c","l","c","c","c","c"), col.headers = "\\hline \\multicolumn{1}{c}{size} & \\multicolumn{1}{c}{} & \\multicolumn{3}{c}{power} \\\\  \n \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{$e_0=-0.25$} & \\multicolumn{1}{c}{$e_0=0$} & \\multicolumn{1}{c}{$e_0=0.25$}\\\\ \\hline \n ", comment = FALSE)
...
# create Table A.2
mytex(tab, file="tableA2_test", sanitize.text.function = function(x) x, include.colnames = F, include.rownames=F, include.dup.rownames=F, include.dup.colnames=T, align=c("c","l","c","c","c","c"), col.headers = "\\hline \\multicolumn{1}{c}{size} & \\multicolumn{1}{c}{} & \\multicolumn{3}{c}{power} \\\\  \n \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{} & \\multicolumn{1}{c}{$e_0=-0.25$} & \\multicolumn{1}{c}{$e_0=0$} & \\multicolumn{1}{c}{$e_0=0.25$}\\\\ \\hline \n ", comment = FALSE)
